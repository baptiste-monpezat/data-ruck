...
langAlternate: "rugby-home-advantages-en"
lang: "fr"
...
Le ballon est récupéré au sol par un joueur Français hors jeu, l'équipe de France est pénalisée et les Irlandais trouvent une touche 
...
Maintenant que nous avons listé tous les facteurs qui peuvent favoriser une équipe à domicile, il est temps
...
à l'extérieur: environ 1 chance sur 5. 
...
joués au pied (**+5%**). Les équipes à domicile font également moins de plaquages, **-8% de plaquages réussis et -13% de plaquages manqués.** 

Les botteurs sont plus en confiance: ils réusssisent en moyenne plus de pénalités à domicile (**+21%**).

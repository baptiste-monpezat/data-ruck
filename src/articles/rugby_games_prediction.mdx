...
Ici le phénomène que l'on doit modéliser, c'est le résultat d'un match de rugby entre deux équipes. Pour cela nous disposons des résultats, classements et statistiques de matchs de PRO D2 ET TOP 14 
depuis 2004.\

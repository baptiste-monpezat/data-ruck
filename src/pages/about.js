...
const About = () => {
    ...
    return (
        <Layout pageTitle="About">
            <div class="flex flex-col items-center mx-auto w-full max-w-[1200px] p-12 gap-10 md:p-24 md:flex-row">
                <StaticImage class="flex-none rounded-full h-36 w-36" alt="Baptiste Monpezat" src="../images/baptiste.jpeg" />
                <div class="flex flex-col font-semibold whitespace-normal text-ellipsis max-w-[800px] text-justify text-red-900 dark:text-white gap-3">
